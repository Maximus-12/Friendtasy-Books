...
public class MybookFragmentSelect extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_mybook_select, container, false);
        NavController navCtrl = findNavController(this);
        Button yesbutton = root.findViewById(R.id.yesbutton);
        yesbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navCtrl.navigate(R.id.nav_mybook_cstore);
            }
        });
        return root;
    }
